...
$result = mysqli_query($con, "UPDATE SetElectiontimer  SET date='$date' WHERE id=1");
$result = mysqli_query($con, "UPDATE SetElectiontimer  SET h='$h' WHERE id=1");
$result = mysqli_query($con, "UPDATE SetElectiontimer  SET m='$m' WHERE id=1");
$result = mysqli_query($con, "UPDATE SetElectiontimer  SET s='$s' WHERE id=1");	
...
?>
     ...
     <script >
         ...
         function AddNew(){
             ...
             newDiv.innerHTML = "<input name= CID[] type=hidden class = text placeholder=ID> <input name=PPIC[] type=file class = img > <input name= PNAME[] type=text class = text placeholder=Name>";
