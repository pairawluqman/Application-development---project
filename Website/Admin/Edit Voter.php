...
$id = $_GET['id'];
$sql= "SELECT * from Users where nationalid=$id";
...
<body>
    ...
    <div class="col-sm-6">
    <input type="text" name = "nationalid" requierd class = "form-control" value=<?php echo $id; ?>>
    </div>
</div>
          <div class="row mb-3">
        <label class="form-label">image</label>
        <div class="col-sm-6">
        <input type="file" id="img" name = "v_image" requierd class = "form-control" >
        </div>
       </div>
    ...
    <div class="col-sm-6">
    <input type="text" name = "dateofissue" requierd class = "form-control" value=<?php echo $DOI; ?>>
    </div>
    </div>
    ...
    <div class="col-sm-6">
    <input type="text" name = "dateofbirth" requierd class = "form-control" value=<?php echo $DOB; ?>>
    </div>
    </div>
    ...
    <div class="col-sm-6">
    <input type="text" name = "v_expiredate" requierd class = "form-control" value=<?php echo $EX; ?>>
    </div>
    </div>
