...
<input class="btn btn-primary"type="submit" name="submit">
    ...
    <input class="form-control"type="file" id="img" name = "v_image" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">nationalid</label>
    <input class="form-control"type="text" name = "NID" requierd class = "form-control" required>
    <br><br>
    <label class = "label" for="">Fullname</label>
    <input class="form-control"type="text" name = "F_name" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">title</label>
    <input class="form-control"type="text" name = "T" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">bloodtype</label>
    <input class="form-control"type="text" name = "B_type" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">placeofissue</label>
    <input class= "form-control"type="text" name = "P_issue" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">dateofissue</label>
    <input class="form-control"type="text" name = "D_issue" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">dateofbirth</label>
    <input class="form-control"type="text" name = "D_birth" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">placeofbirth</label>
    <input class="form-control" type="text" name = "P_birth" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">gender</label>
    <input class="form-control"type="text" name = "Gen" requierd class = "form-control">
    <br><br>
    <label class= "label"for="">expiredate</label>
    <input class="form-control"type="text" name = "EXP" requierd class = "form-control">
    <br><br>
    <div class="message">
        <?php
