...
<div id="photo" >
            ...
            <img src="../upload/<?php echo $userdata['VoterImage']?>" height="200" width="200">

        </div>
        <b>National ID: </b><?php echo$userdata['National_ID']?><br>
        ...
        <b>Expire Date: </b><?php echo $userdata['ExpireDate'] ?><br>
