...
<nav>
    ...
    <section class="dashboard" id="sec">
        ...
        <?php
          $res= mysqli_query($link,"select * from selectionparty");
...
<div class="3">
    ...
    <div class="4" >
        <br>
        <h2 id="one"><?php echo $row["Party_Name"] ?></h2><br>
<img src="../upload/<?php echo $row["Party_Pic"]?>" height="150" width="200"  >
   <br><br>

   <form action="../Database/vote.php" method="POST" onsubmit="return submitForm(this);">
   <input type="hidden" name="Party_Name" value="<?php echo $row["Party_Name"] ?>">
